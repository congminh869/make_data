...
path1 = '/home/minh/Documents/minh/ai_thay_cuong/vietocr/data/hor/train_serial_hor/InkData_line_processed/'
...
def generate(lock, index):
    ...
    for i in range(number_images):
        ...
        images_path[index] = img_path_save + string[index] + '_' + 'img%09d'%i + 't'+str(index) +'.jpg'
